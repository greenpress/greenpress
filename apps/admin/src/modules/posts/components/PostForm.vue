		  ...
		  <gp-editor :model-value="post.short || editedPost.short" @input="editedPost.short = $event"
			...
			<el-form-item v-else-if="$route.query.tab === 'content'" class="form-item-flex">
				<div class="post-contents">
					...
					<el-button class="add-content" native-type="button" type="text" icon="el-icon-plus" @click="addContent"/>
				</div>
			</el-form-item>
		</div>
	</el-form>
...
export default {
	components: {EditPostHeader, PostFormMetadata, AssetUploader, PostContentEditor, FormInput},
	props: {
		post: Object,
		submitting: Boolean
	},
