...
export const cookieTokenVerificationTime = Number(process.env.COOKIE_TOKEN_VERIFICATION_TIME || 1);//TEN_MINUTES
export const processedCookiExpiration =Number(process.env.PROCESSED_COOKIE_EXPIRATION || 30);
